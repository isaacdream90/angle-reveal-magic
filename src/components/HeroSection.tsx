...
const HeroSection = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center relative z-10">
      ...
      >
        <motion.span 
          className="text-primary font-display text-sm tracking-[0.4em] uppercase mb-6 block"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.h1 
          className="text-6xl md:text-8xl lg:text-9xl font-display font-bold mb-6 glow-text"
        ...
        >
          ...
          <button className="px-8 py-4 border border-border text-foreground font-display font-semibold rounded-full hover:bg-secondary transition-all duration-300">
            Learn More
          </button>
        </motion.div>
      </motion.div>
